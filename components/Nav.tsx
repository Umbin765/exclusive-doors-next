                ...
                {activeMenu === key && (
                  <div className="absolute top-full left-0 w-[660px] bg-white shadow-2xl border border-gray-100 p-6 grid grid-cols-[160px_1fr] gap-6">
                    ...
                    <div>
                      ...
                      <ul className="space-y-0.5">
                        {menu.categories.map((cat) => (
                          <li key={cat}>
                            <a
                              href="#"
                              className="text-sm text-gray-700 hover:text-amber-400 transition-colors block py-1"
                            >
                              {cat}
                            </a>
                          </li>
                      ...
                      <a
                        href={menu.href}
                        className="text-amber-400 text-xs font-semibold mt-4 inline-flex items-center gap-1 hover:gap-2 transition-all"
                      >
                        Vezi toate →
                      </a>
                    </div>
