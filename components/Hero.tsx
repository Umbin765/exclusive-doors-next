      ...
      <div className="relative flex-1 flex items-start">
        <div className="max-w-7xl mx-auto px-6 pt-10 pb-6 w-full" data-aos="fade-up">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-amber-500 text-gray-900 text-xs font-semibold px-4 py-2 rounded-full mt-8 mb-8 hover:bg-amber-400 transition-colors"
          >
          ...
          <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight mb-6 max-w-3xl">
            ...
            <span className="text-amber-500">la comandă</span>{' '}
          ...
          <div className="flex flex-wrap gap-4 mb-14">
            <a
              href="#contact"
              className="inline-flex items-center gap-2 bg-amber-500 text-gray-900 text-sm font-bold px-8 py-3.5 hover:bg-amber-400 transition-colors"
            >
              Programare showroom
