  ...
  return (
    <section className="relative flex flex-col overflow-hidden" style={{ height: 'calc(100vh - 4rem)' }}>
      ...
      <div className="relative flex-1 flex items-start">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-16 sm:pt-20 lg:pt-24 pb-6 w-full" data-aos="fade-up">
          {/* Location bubble */}
          <a
            href="https://maps.google.com/?cid=17163938270079558934"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-accent text-gray-900 text-xs font-semibold px-4 py-2 rounded-full mb-8 hover:bg-accent-hover transition-colors"
          >
