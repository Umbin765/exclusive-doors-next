    ...
    <section className={`py-20 border-t border-gray-100 ${alt ? 'bg-stone-50' : 'bg-white'}`} id={id}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-2xl mb-12" data-aos="fade-up">
          <p className="text-xs font-bold tracking-[0.25em] uppercase text-yellow-400 mb-4">
            {eyebrow}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6" data-aos="fade-up">
            {subCards.map((card) => (
              <a
                key={card.title}
                href="#contact"
                className="group block border-2 border-transparent rounded-xl overflow-hidden shadow-md hover:border-yellow-400 hover:shadow-[0_8px_40px_rgba(0,0,0,0.18)] transition-all duration-300"
              >
