    ...
    <section className="grid lg:grid-cols-2 min-h-[520px]">
      ...
      <div className="bg-neutral-900 flex items-center px-10 py-16 lg:px-16">
        <div data-aos="fade-up" className="max-w-lg">
          <p className="text-xs font-bold tracking-[0.3em] uppercase text-amber-400 mb-5">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="#contact"
              className="inline-flex items-center gap-2 bg-amber-400 text-gray-900 text-sm font-bold px-7 py-3.5 hover:bg-amber-300 transition-colors"
            >
              Programare showroom
